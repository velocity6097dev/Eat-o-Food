-- ============================================================
-- Eat-o-Food (Bistro Track) — Database Schema
-- Import this file in phpMyAdmin: Import tab -> choose file -> Go
-- ============================================================

-- Forces the import connection to treat this file as UTF-8, so the
-- emoji in menu_items import correctly no matter what charset your
-- MySQL client/OS defaults to. Without this, emoji can get mangled
-- ("double-encoded") on import on some systems.
SET NAMES utf8mb4;

CREATE DATABASE IF NOT EXISTS eat_o_food
